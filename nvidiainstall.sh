if pacman -Q zsh &> /dev/null; then
    ...
    echo "Or remove this if section via your texteditor like: vim nvidiainstall.sh"
    exit
fi
...
if pacman -Q nvidia-open-dkms &> /dev/null; then
    ...
    wget -O ~/.config/d3f4l7d/autoinstall/nvidia/gcc12-12.3.0-6-x86_64.pkg.tar.zst https://archive.archlinux.org/packages/g/gcc12/gcc12-12.3.0-6-x86_64.pkg.tar.zst
    wget -O ~/.config/d3f4l7d/autoinstall/nvidia/gcc12-libs-12.3.0-6-x86_64.pkg.tar.zst https://archive.archlinux.org/packages/g/gcc12-libs/gcc12-libs-12.3.0-6-x86_64.pkg.tar.zst
    wget -O ~/.config/d3f4l7d/autoinstall/nvidia/cuda-12.3.2-1-x86_64.pkg.tar.zst https://archive.archlinux.org/packages/c/cuda/cuda-12.3.2-1-x86_64.pkg.tar.zst
    wget -O ~/.config/d3f4l7d/autoinstall/nvidia/cudnn-8.9.7.29-1-x86_64.pkg.tar.zst https://archive.archlinux.org/packages/c/cudnn/cudnn-8.9.7.29-1-x86_64.pkg.tar.zst
    sudo pacman -U --noconfirm ~/.config/d3f4l7d/autoinstall/nvidia/gcc12-12.3.0-6-x86_64.pkg.tar.zst ~/.config/d3f4l7d/autoinstall/nvidia/gcc12-libs-12.3.0-6-x86_64.pkg.tar.zst ~/.config/d3f4l7d/autoinstall/nvidia/cuda-12.3.2-1-x86_64.pkg.tar.zst ~/.config/d3f4l7d/autoinstall/nvidia/cudnn-8.9.7.29-1-x86_64.pkg.tar.zst
