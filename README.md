...
For CLI lovers,
```
./helloworld.sh 2>&1 | tee ~/.d3f4l7d/autoinstall/log/helloworld_stdouterr.txt
```
For ML lovers,
```
...
For GUI users,
```
./finallyyoushouldusegui.sh 2>&1 | tee ~/.d3f4l7d/autoinstall/log/finallyyoushouldusegui_stdouterr.txt
```
Enjoy it 👽
